...
<title><%=keyword%> 공지사항 검색 결과</title>
    ...
    <div class="container">  
	  ...
	  <div class="row">
	   ...
	   <div class="row">    
        ...
        <form class="form-inline" action="/noticeSearch.do" method="POST">
            <center>  
                <select name="selectSearch" class="form-control">
			        ...
			        <button class="btn btn-default form-control" id="writeBtn" type="button"><span class="glyphicon glyphicon-search"></span></button>
